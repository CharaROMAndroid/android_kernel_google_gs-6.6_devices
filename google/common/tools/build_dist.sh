...
python3 download_prebuilts.py --force --build_target kernel_aarch64 --build_id 15511674
python3 download_prebuilts.py --force --build_target kernel_aarch64_16k --build_id 15511674
